...
Advanced companion to the [UI/UX playbook](../principles/uiux-design-playbook.md). Sources checked 19 September 2026. The examples below distinguish published criteria, research guidance, observations, and our proposed decisions. They teach a reasoning method; they do not certify expertise or report a completed user study.
...
For a formative study, report participant observations and limits directly. Use the [research worksheet](../templates/user-research-study.md) to investigate the first misunderstandings before designing a quantitative effect study. A task instructed by a moderator also differs from spontaneous browsing; preserve that distinction when reporting what happened.

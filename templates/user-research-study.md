...
This worksheet operationalizes the [UI/UX design playbook](../principles/uiux-design-playbook.md). It is a proposed protocol, not an industry-mandated procedure. Its aim is to identify misunderstandings and interaction problems in the current preview before using behavioral metrics to judge improvements.
